package io.github.hunachi.homechecklistapp.ui.ui.contact
...
class ContactListAdapter : ListAdapter<ContactItem, ContactListAdapter.ViewHolder>(
    DIFFUtil
) {
        ...
        fun bind(contactItem: ContactItem) {
            view.findViewById<TextView>(R.id.message).apply {
                text = contactItem.contactData.memo + "\n" + contactItem.checkItemName +
                        "\n" + "登録日${contactItem.contactData.stringDate()}"
            }
